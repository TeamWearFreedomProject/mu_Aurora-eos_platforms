...
[Defines]
  ...
  OUTPUT_DIRECTORY               = Build/AuroraPkg
...
[PcdsFixedAtBuild.common]
  ...
  # SMBIOS
  gSelunaPkgTokenSpaceGuid.PcdSmbiosSystemModel|"Aurora"
  gSelunaPkgTokenSpaceGuid.PcdSmbiosSystemRetailModel|"XXXX"
  gSelunaPkgTokenSpaceGuid.PcdSmbiosSystemRetailSku|"Aurora"
  gSelunaPkgTokenSpaceGuid.PcdSmbiosBoardModel|"Aurora"

  # Simple FrameBuffer
  gSelunaPkgTokenSpaceGuid.PcdMipiFrameBufferWidth|384
  gSelunaPkgTokenSpaceGuid.PcdMipiFrameBufferHeight|384
  gSelunaPkgTokenSpaceGuid.PcdMipiFrameBufferPixelBpp|32

  gSelunaPkgTokenSpaceGuid.PcdABLProduct|"aurora"

[PcdsDynamicDefault.common]
  gEfiMdeModulePkgTokenSpaceGuid.PcdVideoHorizontalResolution|384
  gEfiMdeModulePkgTokenSpaceGuid.PcdVideoVerticalResolution|384
  gEfiMdeModulePkgTokenSpaceGuid.PcdSetupVideoHorizontalResolution|384
  gEfiMdeModulePkgTokenSpaceGuid.PcdSetupVideoVerticalResolution|384
  gEfiMdeModulePkgTokenSpaceGuid.PcdSetupConOutColumn|48 # 384 / EFI_GLYPH_WIDTH(8)
  gEfiMdeModulePkgTokenSpaceGuid.PcdSetupConOutRow|20 # floor(384 / EFI_GLYPH_HEIGHT(19))
